...
//        mongoClient = new MongoClient(new MongoClientURI("mongodb://kwiner:test123@127.0.0.1/test?authMechanism=MONGODB-CR&maxPoolSize=500"));
    ...
    protected String getConnectionDriverName() {
        throw new UnsupportedOperationException("getConnectionDriverName do not Operation by mongodb");
    }

    @Override
    @Deprecated
    protected String getConnectionString(String dbnameString) {
        throw new UnsupportedOperationException("getConnectionString do not Operation by mongodb");
    }

    @Override
    @Deprecated
    public void createTable(Connection con, Class<?> clazz) throws Exception {
        throw new UnsupportedOperationException("createTable do not Operation by mongodb");
    }
    ...
    protected void createTable(Connection con, String tableName, List<SqlColumn> columns, List<List<String>> columnKeys) throws Exception {
        throw new UnsupportedOperationException("createTable do not Operation by mongodb"); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    @Deprecated
    protected boolean existsTable(Connection con, String tableName, List<SqlColumn> columns) throws Exception {
        throw new UnsupportedOperationException("existsTable do not Operation by mongodb"); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    @Deprecated
    protected boolean existsColumn(Connection con, String tableName, String columnName) throws Exception {
        throw new UnsupportedOperationException("existsColumn do not Operation by mongodb"); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    @Deprecated
    public int createDatabase(String database) throws Exception {
        throw new UnsupportedOperationException("createDatabase do not Operation by mongodb");
    }
    ...
    public int update(Connection con, int constCount, T... objs) throws Exception {
        throw new UnsupportedOperationException("update do not Operation by mongodb");
    }
    ...
    public int executeUpdate(Connection con, String sql, Object... objs) throws Exception {
        throw new UnsupportedOperationException("executeUpdate do not Operation by mongodb");
    }
    ...
    protected boolean existsColumn(String tableName, String columnName) throws Exception {
        throw new UnsupportedOperationException("existsColumn do not Operation by mongodb");
    }

    @Override
    @Deprecated
    public boolean existsTable(Connection con, T t, boolean isCloumn) throws Exception {
        throw new UnsupportedOperationException("existsTable do not Operation by mongodb");
    }
