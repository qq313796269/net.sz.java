...
public class BuffType implements Serializable {
    ...
    // <editor-fold desc="是否包含一个状态 public boolean hasFlag(BuffType buffType) ">
    /**
     * 是否包含一个状态
     *
     * @param tvalue
    ...
    // <editor-fold desc="增加一个状态 public void addStatus(BuffType buffType)">
    /**
     * 增加一个状态
     *
     * @param buffType
    ...
    // <editor-fold desc="移除一个状态 public void removeStatus(BuffType buffType)">
    /**
     * 移除一个状态
     *
     * @param buffType
