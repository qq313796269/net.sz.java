...
public class HttpUtil {
    ...
    public static void main(String[] args) throws IOException {
        final SzLogger log = SzLogger.getLogger();
//        for (int j = 0; j < 4; j++) {
...
//                        long currentTimeMillis1 = TimeUtil.currentTimeMillis();
...
//        }
        ...
        System.in.read();
        log.info("start");
        HttpUtil.urlGet("http://www.kuaidi100.com/?from=openv");
        log.info("Done");
    }
