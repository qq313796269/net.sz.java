...
public class MapInfo extends MapObject {
     ...
     * @return
     */
    public boolean addTask(BaseTask taskModel) {
        return MapThreadExecutor.MapAllExcutor.addTask(getMapKey(), taskModel);
    }
     ...
     * @return
     */
    public boolean addTimerTask(TimerTask timerEvent) {
        return MapThreadExecutor.MapAllExcutor.addTimerTask(getMapKey(), timerEvent);
    }
