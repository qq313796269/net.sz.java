...
public final class NioHttpRequest {
    ...
    /*post或者get完整参数*/
    private ObjectAttribute params;
    /*域名*/
    ...
    public ObjectAttribute getParams() {
        return params;
    }

    public void setParams(ObjectAttribute params) {
        this.params = params;
    }
    ...
    @Override
    public String toString() {
        return "{" + "domainName=" + domainName + ", httpMethod=" + httpMethod + ", url=" + url + ", ip=" + ip + ", httpBody=" + httpBody + '}';
    }
