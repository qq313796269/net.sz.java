...
public class ObjectBase implements Cloneable, Serializable {
     ...
     * 其他属性
     */
    private ObjectAttribute variables = null;
    /**
     * 不需要保存的序列化对象
     */
     ...
     * @return
     */
    public ObjectAttribute getVariables() {
        if (variables == null) {
    ...
    @Deprecated
    public void setVariables(ObjectAttribute variables) {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.tmpOthers == null) {
            ...
            ob.tmpOthers = (ObjectAttribute) tmpOthers.clone();
        }

        if (this.variables == null) {
            ob.variables = null;
        } else {
            ob.variables = (ObjectAttribute) variables.clone();
        }
