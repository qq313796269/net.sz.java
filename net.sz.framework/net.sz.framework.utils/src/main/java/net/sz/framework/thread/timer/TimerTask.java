package net.sz.framework.thread.timer;
 ...
 */
public abstract class TimerTask extends BaseTask implements Cloneable {
     ...
     */
    public TimerTask(long startTime, boolean isStartAction, long endTime, int maxExecCount, int intervalTime) {
        super();
     ...
     * @param intervalTime 指定间隔时间
     */
    public TimerTask(long startTime, boolean isStartAction, int maxExecCount, int intervalTime) {
     ...
     * @param intervalTime 指定间隔时间
     */
    public TimerTask(boolean isStartAction, long endTime, int maxExecCount, int intervalTime) {
     ...
     * @param intervalTime 指定间隔时间
     */
    public TimerTask(long startTime, long endTime, int intervalTime) {
     ...
     * @param intervalTime 指定间隔时间
     */
    public TimerTask(int maxExecCount, int intervalTime) {
