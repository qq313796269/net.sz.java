 ...
 * @param <V>
 */
public class NodeEnty2<K extends Serializable, V extends Serializable> implements Cloneable, Serializable {

    private static final long serialVersionUID = 3154204303067497676L;

    public static void main(String[] args) {
        NodeEnty2<String, Serializable> nodeEnty2 = new NodeEnty2<>("1", "2", 5);
    }
