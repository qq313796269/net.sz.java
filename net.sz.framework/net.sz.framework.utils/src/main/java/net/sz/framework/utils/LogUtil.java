...
//        int random = RandomUtils.random(10001, 10002);
        String text = GlobalUtil.getGameId() + "" + GlobalUtil.getPlatformId() + "" + GlobalUtil.getServerId() + "" + sendTime + "" + sign;

        String md5Encode = MD5Util.md5Encode(text);

        return "{\"gameId\":" + GlobalUtil.getGameId() + ",\"sign\":\"" + md5Encode + "\",\"platformId\":" + GlobalUtil.getPlatformId() + ",\"sendTime\":" + sendTime + ",\"serverId\":" + GlobalUtil.getServerId() + ",\"infos\":[" + string + "]}";
    }
...
//        paramData = "{\"identify\":\"" + GlobalUtil.getId() + "\"," + "\"createTime\":\"" + TimeUtil.currentTimeMillis() + "\"," + paramData + "}";
...
//        addLogQueue(paramData);
    ...
    void addLogQueue(String paramData) {
        ...
        } else if (TimeUtil.currentTimeMillis() - lastSendMailTime > 5 * 60 * 1000) {
            lastSendMailTime = TimeUtil.currentTimeMillis();
