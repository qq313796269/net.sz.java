    ...
    static public long verifyDateEndTime(Calendar calendar, String timeStr) {
        ...
        for (String item : items) {
            ...
            if (verifyConfigTimeStr(calendar, item)) {
                ...
                ArrayList<Integer> tempWeeks;
                if (!"*".equals(weeks)) {
                    int week = calendar.get(Calendar.DAY_OF_WEEK) - 1;
                    if (week < 1) {
                        week = 7;
                    }
                    tempWeeks = getConfigDate(calendar, week, weeks);
                } else {
                    tempWeeks = new ArrayList<>();
                }
                            ...
                            for (int h = 0; h < tempHHMMs.size(); h++) {
                                ...
                                try {
                                    ...
                                    if (hour == 23 && minute == 59) {//把时间加1分钟
                                        ...
                                        if (tempDays.contains(calendar1.get(Calendar.DAY_OF_MONTH))) {
                                            int week = calendar1.get(Calendar.DAY_OF_WEEK) - 1;
                                            if (week < 1) {
                                                week = 7;
                                            }
                                            if (tempWeeks.contains(week)) {
                                                continue;
                                            }
                                        }
                                    }
