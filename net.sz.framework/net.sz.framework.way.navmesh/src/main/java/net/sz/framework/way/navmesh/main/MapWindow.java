...
//            }
    ...
    private ViewPane createViePane() {
        ...
        map = loadMap(path + File.separatorChar + "1110.navmesh");
        if (map == null) {
            path = file.getPath() + File.separatorChar + "target" + File.separatorChar + "1110.navmesh";
            map = loadMap(path);
        }
        if (map == null) {
            path = file.getPath() + File.separatorChar + "Nav_build" + File.separatorChar + "1110.navmesh";
            map = loadMap(path);
        }
