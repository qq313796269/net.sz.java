...
public class BuffStateType implements Serializable {
    ...
    // <editor-fold defaultstate="collapsed" desc="是否包含一个状态 public boolean hasFlag(BuffStateType buffType) ">
    /**
     * 是否包含一个状态
     *
     * @param buffType
    ...
    // <editor-fold defaultstate="collapsed" desc="增加一个状态 public void addStatus(BuffStateType buffType)">
    /**
     * 增加一个状态
     *
     * @param buffType
    ...
    // <editor-fold defaultstate="collapsed" desc="移除一个状态 public void removeStatus(BuffStateType buffType)">
    /**
     * 移除一个状态
     *
     * @param buffType
