...
public abstract class TimerTaskModel extends TaskModel implements Cloneable {
    ...
    public String toString() {
        return super.toString() + ",startTime=" + startTime + ", startAction=" + startAction + ", endTime=" + endTime + ", intervalTime=" + intervalTime + ", beforeEnd=" + beforeEnd + ", maxExecCount=" + maxExecCount + ", execCount=" + execCount + ", lastTime=" + lastTime;
    }
