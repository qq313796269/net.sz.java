...
public class Move {
    ...
    // <editor-fold defaultstate="collapsed" desc="寻路相关模块">
    //从开启列表查找F值最小的节点
    ...
    // <editor-fold defaultstate="collapsed" desc="检查当前节点附近的节点 private static void checkP8(Point p0, byte[][] map, Point pa, Point pb, HashMap<String, Point> Open_List, HashMap<String, Point> Close_List)">
    /**
     * 检查当前节点附近的节点
     *
     * @param p0
    ...
    // <editor-fold defaultstate="collapsed" desc="寻路路径  static public Point findWay(byte[][] r, int sx, int sz, int ex, int ez)">
    /**
     *
     * @param r
     * @param sx
...
//        return points;
    ...
    // <editor-fold defaultstate="collapsed" desc="打印地图阻挡信息 public static void printMap(byte[][] r)">
    /**
     * 打印地图阻挡信息
     *
     * @param r
    ...
    // <editor-fold defaultstate="collapsed" desc="打印路径 static public void printWay(byte[][] r, Point way)">
    /**
     * 打印路径
     *
     * @param r
