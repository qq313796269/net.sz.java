...
public class Buff implements Serializable {
    ...
    private long effect;
    //作用方
    private Person.SpiritType effectType;
    //来源类型 来源类型 Person的类型
    private long source;
    //来源者类型
    private Person.SpiritType sourceType;
    //创建时间
    ...
    public Person.SpiritType getEffectType() {
        return effectType;
    }

    public void setEffectType(Person.SpiritType effectType) {
    ...
    public Person.SpiritType getSourceType() {
        return sourceType;
    }

    public void setSourceType(Person.SpiritType sourceType) {
